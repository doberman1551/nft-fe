...
export const FeautredJobs = () => {
    return (
    
        <div>
        <div className="flex items-center justify-center w-screen min-h-screen p-10">
             <h1 className="text-5xl md:text-6xl font-extrabold leading-tighter tracking-tighter  text-white" data-aos="zoom-y-out">Featured Jobs</h1>
             </div>
        <div className="flex items-center justify-center w-screen min-h-screen p-10">
